...
def main():
    ...
    if done:
        ...
        if show_path:
            scenario.show_path(scenario.map, x, y, unnecessary_steps, sleep_dt=0.05,grad_dir_along_path_shortest=grad_dir_along_path_shortest, dist_map=dist_map, show_dist_map=False)
